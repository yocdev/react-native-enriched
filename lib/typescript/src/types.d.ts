...
import type { ColorValue, DimensionValue, NativeMethods, NativeSyntheticEvent, ReturnKeyTypeOptions, TargetedEvent, TextStyle, ViewProps, ViewStyle } from 'react-native';
...
export interface EnrichedTextInputProps extends Omit<ViewProps, 'children'> {
    ...
    onMaxLengthExceeded?: (e: NativeSyntheticEvent<OnMaxLengthExceededEvent>) => void;
...
export interface EnrichedTextInputWebProps extends Omit<EnrichedTextInputProps, 'style'> {
